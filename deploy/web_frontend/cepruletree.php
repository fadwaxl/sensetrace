...
$jsontree='[';
	...
	//{
		$jsontree="$jsontree".
		'{"title":"'."$_GET[key]".':diff","icon":false,"isFolder":false,"isLazy":false,"key":"'."$_GET[key]".':diff"},'.
		'{"title":"'."$_GET[key]".':union","icon":false,"isFolder":false,"isLazy":false,"key":"'."$_GET[key]".':union"}'.
	//}
