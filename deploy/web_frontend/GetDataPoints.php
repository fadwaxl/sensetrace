...
if ((($dateto - $datefrom) > 600) and (($dateto - $datefrom) <= 6000)) {
    $intervallstring = ":1min";
}
else 
if ((($dateto - $datefrom) > 6000) and (($dateto - $datefrom) <= 60000)) {
    $intervallstring = ":15min";
}
else 
if ((($dateto - $datefrom) > 60000) and (($dateto - $datefrom) <= 1200000)) {
    $intervallstring = ":1h";
}
else 
if ((($dateto - $datefrom) > 1200000) and (($dateto - $datefrom) <= 32832000)) {
    $intervallstring = ":1d";
}
else 
if (($dateto - $datefrom) > 32832000) {
    $intervallstring = ":1m";
}
$corr = "";
...
if ($sensor == "urn:stg_1:weather:WindSpeed") {
    echo '{ "label": "' . $sensor . '", "data": ' . $jsontree . ', "yaxis": 2  }';
}
else 
if ($sensor == "urn:stg_1:weather:radiationfoto") {
